...
// client_test.go covers *Client construction (NewClient), credential
// lifecycle (Login + refreshSession), and shared test helpers consumed
// by every transport test file. Per-transport behaviour lives in:
